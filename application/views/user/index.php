		...
		<div class="col-md-3 left_col">
			<div class="left_col scroll-view">
				<div class="navbar nav_title" style="border: 0;">
					<a href="<?= base_url('user'); ?>" class="site_title"><i class="fa fa-home"></i> <span>Onlymsglow</span></a>
				</div>
				...
				<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
					<div class="menu_section">
						...
						<ul class="nav side-menu">
							<li>
								<a><i class="fa fa-truck"></i> Supplier</a>
							</li>
							<li>
								<a><i class="fa fa-users"></i> Pelanggan</a>
							</li>
							<li><a><i class="fa fa-sitemap"></i> Produk <span class="fa fa-chevron-down"></span></a>
							...
							<li>
								<a><i class="fa fa-money"></i>Transaksi</a>
							</li>
					...
					<div class="menu_section">
						...
						<ul class="nav side-menu">
							<li>
								<a href="javascript:void(0)"><i class="fa fa-user"></i> Pengguna</a>
							</li>
